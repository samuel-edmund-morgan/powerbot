...
async def cb_donate(callback: CallbackQuery):
    ...
    text = (
        ...
        "Якщо він вам корисний і ви хочете підтримати його розвиток — можете пригостити розробника кавою ☕\n\n"
...
async def reply_donate(message: Message):
    """Обробник кнопки підтримки розробника (ReplyKeyboard, для сумісності)."""
    if await handle_webapp_reply_keyboard(message):
        return
    text = (
        "☕ <b>Подякувати розробнику</b>\n\n"
