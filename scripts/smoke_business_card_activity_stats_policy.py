...
def main() -> None:
    ...
    _must(handlers_text, 'action="logo_open"', where="src/business/handlers.py", errors=errors)
    _must(handlers_text, 'action="gallery_open"', where="src/business/handlers.py", errors=errors)
    ...
    _must(handlers_text, 'action="partner_photo_1"', where="src/business/handlers.py", errors=errors)
    _must(handlers_text, 'action="partner_photo_2"', where="src/business/handlers.py", errors=errors)
    _must(handlers_text, 'action="partner_photo_3"', where="src/business/handlers.py", errors=errors)
    ...
    _must(handlers_text, "Відкриття логотипу/фото", where="src/business/handlers.py", errors=errors)
    _must(handlers_text, "Відкриття галереї", where="src/business/handlers.py", errors=errors)
    ...
    _must(handlers_text, "Відкриття фото 1 (Partner)", where="src/business/handlers.py", errors=errors)
    _must(handlers_text, "Відкриття фото 2 (Partner)", where="src/business/handlers.py", errors=errors)
    _must(handlers_text, "Відкриття фото 3 (Partner)", where="src/business/handlers.py", errors=errors)
