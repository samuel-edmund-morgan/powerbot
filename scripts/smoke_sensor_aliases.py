...
async def main() -> None:
    ...
    try:
        ...
        try:
            ...
            # 2) format_light_status should use alias virtual totals + non-zero history.
            ...
            # 3) Notification-routing contract for alias sections:
            ...
            # 4) Stats fallback for unique alias source.
            ...
            # 5) Ambiguous alias target must NOT fallback to any source history.
